...
VALUES  ( N'Cafe đen', -- name - nvarchar(100)
          1, -- idCategory - int
          15000)
INSERT dbo.Food
        ( name, idCategory, price )
VALUES  ( N'Cafe sữa', 1, 15000)
INSERT dbo.Food
        ( name, idCategory, price )
VALUES  ( N'Bạc sỉu', 1, 15000)
...
INSERT dbo.Food
        ( name, idCategory, price )
VALUES  ( N'Trà sữa matcha', 3, 20000)

INSERT dbo.Food
        ( name, idCategory, price )
VALUES  ( N'Cá viên chiên', 4, 20000)
INSERT dbo.Food
        ( name, idCategory, price )
VALUES  ( N'Snack', 4, 5000)
